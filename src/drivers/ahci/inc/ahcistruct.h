...
typedef volatile struct _HBA_REGISTERS {
    struct {
    ...
    #define HBA_GHC_INTENABLE 2
    #define HBA_GHC_MSIREVERTSINGLEMSG 4
...
typedef volatile struct _AHCI_COMMAND_LIST_ENTRY {
...
typedef volatile struct _PHYSICAL_REGION_DESCRIPTOR_TABLE {
...
typedef volatile struct _AHCI_RECEVIED_FIS {
