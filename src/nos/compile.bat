...
set libsource=../../lib
cl /O2 %srcfiles% /GS- /I../../inc "../../build/nos/assembly/*.obj" "../../lib/syscruntime.lib" /KERNEL /Fo:../../build/nos/ /Fe:noskx64.exe  /link /PDB:no /FIXED /LARGEADDRESSAWARE /RELEASE /BASE:0xffff800000000000 /ENTRY:NosKernelEntry /SUBSYSTEM:native
